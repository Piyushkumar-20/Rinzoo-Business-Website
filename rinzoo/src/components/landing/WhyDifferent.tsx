...
const DEFAULT_IMG = "https://images.unsplash.com/photo-1635274605638-d44babc08a4f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3ODc2NDd8MHwxfHNlYXJjaHwxfHxmcmVzaCUyMHdoaXRlJTIwZm9sZGVkJTIwY2xvdGhlcyUyMGxhdW5kcnl8ZW58MXwwfHx8MTc4MDUwMjE4Mnww&ixlib=rb-4.1.0&q=80&w=800";

export function WhyDifferent({ content }: { content?: SectionContent }) {
  const c = (content ?? {}) as Record<string, string>;
  const badge = c.badge || "Why Rinzoo Is Different";
  const heading = c.heading || "Premium Clean, Without Premium Pricing";
  const description = c.description || "Same powerful results you expect from premium brands — at a price that respects your budget.";
